...
#C file write time: 2024-09-26 10:45:54.198423
data.ss
control.ss
...
-1 # min yr for sdreport outputs (-1 for styr); #_1989
-2 # max yr for sdreport outputs (-1 for endyr+1; -2 for endyr+Nforecastyrs); #_2039
...
-1 # random number seed for bootstrap data (-1 to use long(time) as seed): # 1727372778
