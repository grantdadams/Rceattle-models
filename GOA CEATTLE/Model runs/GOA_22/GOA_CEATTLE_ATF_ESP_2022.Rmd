...
plot_biomass(list(mod_list_all[[1]], mod_list_all[[3]]), line_col = cols, species = 2, model_names = "Single-spp CEATTLE", "Multi-spp CEATTLE", add_ci = TRUE)
...
plot_b_eaten_sex(mod_list_all[[3]], line_col = cols[2], species = 2)
dev.off()
