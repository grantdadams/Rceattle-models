...
ESP_plot <-function(msModel, ssModel, age = 1, minage = 4, endyr = 2023, species = 1){
  ...
  # - M-at-age ----
  M2 <- rbind(
    data.frame(Year = c(yrs, 2050), SSM= c(ssModel$quantities$M_at_age[1,1,age,1:length(yrs)], 1) , MSM= c(msModel$quantities$M_at_age[1,1,age,1:length(yrs)], NA), Spp = 1,  Species = "Prey: Walleye pollock"),
    data.frame(Year = c(yrs, 2050),SSM= c(ssModel$quantities$M_at_age[3,1,age,1:length(yrs)], .4) , MSM= c(msModel$quantities$M_at_age[3,1,age,1:length(yrs)], NA), Spp = 3,  Species = "Prey: Pacific cod"),
    data.frame(Year = c(yrs, 2050),SSM= c(ssModel$quantities$M_at_age[2,1,age,1:length(yrs)], 0.15) , MSM= c(msModel$quantities$M_at_age[2,1,age,1:length(yrs)], NA), Spp = 2,  Species = "Prey: Females"),
    data.frame(Year = c(yrs, 2050),SSM= c(ssModel$quantities$M_at_age[2,2,age,1:length(yrs)], 0.3) , MSM= c(msModel$quantities$M_at_age[2,2,age,1:length(yrs)], NA), Spp = 2,  Species = "Prey: Males"))
