...
#C file write time: 2024-10-17  11:59:33
#
...
#_LO	HI	INIT	PRIOR	PR_SD	PR_type	PHASE	env_var&link	dev_link	dev_minyr	dev_maxyr	dev_PH	Block	Block_Fxn
  ...
  -99	      99	3.4297e-06	     0	    0	0	 -3	0	0	0	0	0	0	0	#_Wtlen_1_Fem_GP_1   
  -99	      99	   3.27469	     0	    0	0	 -3	0	0	0	0	0	0	0	#_Wtlen_2_Fem_GP_1   
...
1960.7265762409 #_last_yr_nobias_adj_in_MPD; begin of ramp
1988.79004143275 #_first_yr_fullbias_adj_in_MPD; begin of plateau
2021.62057716982 #_last_yr_fullbias_adj_in_MPD
2023.22792123494 #_end_yr_for_ramp_in_MPD (can be in forecast to shape ramp, but SS sets bias_adj to 0.0 for fcast yrs)
...
# F_Method = 2 inputs (was: hybrid N-iter for F_Method = 3):
0.05 # starting F value when not starting from hybrid
1 # phase to switch from hybrid to parameter
0 # N_detailed Fsetups to read (0 = use starting F for all fleet/year)
#
...
#_like_comp	fleet	phase	value	sizefreq_method
   ...
   18	1	1	0	1	#_InitEQ_Regime_Phz1 (lambda 0: turn off the regime soft penalty; matches Rce mode 5)
