...
write.csv(wt_all, file = "Data/2024pcod_wtatage.csv")


# Time series of biomass ----
write.csv(mod0$timeseries, file = "Data/2024pcod_time_series.csv")


# Time series of numbers at age ----
# - We want middle based on when predation occurs
write.csv(mod0$natage, file = "Data/2024pcod_natage.csv")
...
writexl::write_xlsx(alk, path = "Data/2024pcod__alk.xlsx")


# CAAL data ----
mod0$age_comp_fit_table
