...
# Plots ----
print(plot_biomass(list(bridging_model_3, SAFE2022_mod), model_names = c("CEATTLE", "SAFE")) + ggplot2::ylab("Biomass"))
print(plot_ssb(list(bridging_model_3, SAFE2022_mod), model_names = c("CEATTLE", "SAFE")) + ggplot2::ylab("SSB"))
print(plot_recruitment(list(bridging_model_3, SAFE2022_mod), model_names = c("CEATTLE", "SAFE")) + ggplot2::ylab("Recruitment"))
