...
#C file write time: 2024-02-07 15:47:05.282757
hake_data.ss
hake_control.ss
...
-1 # min yr for sdreport outputs (-1 for styr); #_1964
-2 # max yr for sdreport outputs (-1 for endyr+1; -2 for endyr+Nforecastyrs); #_2027
...
-1 # random number seed for bootstrap data (-1 to use long(time) as seed): # 1707349912
