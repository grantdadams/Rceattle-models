...
mydata_atf_fixed$weight[,6:ncol(mydata_atf_fixed$weight)] <- mydata_atf_fixed$weight[,6:ncol(mydata_atf_fixed$weight)] * 0.001 # Convert weight to tonnes
...
SAFE2023multisel_mod$quantities$ssb[1,1:length(1977:2023)] <- SAFE2023multisel$SSB
...
SAFE2023multiselCEATTLE_mod$quantities$ssb[1,1:length(1977:2023)] <- SAFE2023multiselCEATTLE$SSB
