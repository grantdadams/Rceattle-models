...
# Run the model in single species mode to get the estimated parameters. Thesis will be used as initial values for the multi-species mode
...
################################################
# Sensitivity to constant temperature
################################################
...
for(i in 1:nmods){
  ...
  sensitivitiy_data <- Rceattle::read_data(file = paste0(file_list[i]))
...
########################################################
# Compare all single and multi-species models
########################################################

# Create objects containing each model and the names
