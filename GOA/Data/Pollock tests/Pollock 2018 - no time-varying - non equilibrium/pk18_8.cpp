 ...
 model_data(argc,argv) , function_minimizer(sz)
{
  ...
  dev_log_initN.allocate(rcrage+1,trmage,-15,15,3,"dev_log_initN");
  ...
  slp1_fsh_dev.allocate(styr,endyr,-5,5,-1,"slp1_fsh_dev");
  inf1_fsh_dev.allocate(styr,endyr,-5,5,-1,"inf1_fsh_dev");
  ...
  log_q1_dev.allocate(styr,endyr,-5,5,-1,"log_q1_dev");
  ...
  log_q3_dev.allocate(styr,endyr,-5,5,-1,"log_q3_dev");
