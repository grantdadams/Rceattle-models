...
//  init_bounded_number M(0.1,0.5,-1)
  ...
  init_bounded_dev_vector dev_log_initN(rcrage+1,trmage,-15,15,3)
...
//    init_bounded_number inf2_fsh_mean(7,20,-1)
    ...
    init_bounded_dev_vector slp1_fsh_dev(styr,endyr,-5,5,-1)
    init_bounded_dev_vector inf1_fsh_dev(styr,endyr,-5,5,-1)
...
//Fishing mortality and survey catchablility
  ...
  init_bounded_dev_vector log_q1_dev(styr,endyr,-5,5,-1) 
 ...
 //  init_bounded_number log_q2(-10,10,-1)
  ...
  init_bounded_dev_vector log_q3_dev(styr,endyr,-5,5,-1) 
