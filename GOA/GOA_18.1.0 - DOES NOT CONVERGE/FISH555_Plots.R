...
model_names <- c("base", paste0("remove srv", 1:6))
plot_biomass(ss_run[1:7], model_names = model_names)

model_names <- c("base", paste0("remove fsh", 2:4))
plot_biomass(ss_run[c(1,8:10)], model_names = model_names)
