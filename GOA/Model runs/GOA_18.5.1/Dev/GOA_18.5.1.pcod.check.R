...
################################################
# Read the data in
mydata_pcod_fixed <- Rceattle::read_data( file = "Data/GOA_18.5.1_pcod_halibut_single_species_1977-2018.xlsx")
...
pcod_base$data_list$fleet_control$Comp_weights <- pcod_base$data_list$fleet_control$Est_weights_macallister

pcod_base <- Rceattle::fit_mod(
  # cpp_directory = "C:/Users/Grant Adams/Documents/GitHub/Rceattle/inst/executables",
  data_list = pcod_base$data_list,
...
mod_list <- list(pcod_base, pcod_safe)
