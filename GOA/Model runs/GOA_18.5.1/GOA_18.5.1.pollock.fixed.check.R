...
################################################
# Read the data in
mydata_pollock <- Rceattle::read_data( file = "Data/GOA_18.5.1_pollock_single_species_1970-2018_true.xlsx")
...
plot_biomass(list(pollock_fixed, pollock_est), model_names = c("F", "E"))
