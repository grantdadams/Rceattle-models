...
plot_biomass(mod_list_avg, file = file_name, model_names = mod_list_avg_names, right_adj = 0.1, line_col = line_col_avg, lwd = 2, minyr = 1996)
plot_ssb(mod_list_avg, file = file_name, add_ci = FALSE, model_names = mod_list_avg_names, right_adj = 0.1, line_col = line_col_avg, lwd = 2, minyr = 1996)
plot_b_eaten(mod_list_avg, file = file_name, add_ci = FALSE, model_names = mod_list_avg_names, right_adj = 0.1, line_col = line_col_avg, lwd = 2, species = 3, minyr = 1996)
abline(v = 2007)
plot_b_eaten_prop(mod_list_avg, file = file_name, add_ci = FALSE, model_names = mod_list_avg_names, right_adj = 0.1, line_col = line_col_avg, lwd = 2, species = 1:3, minyr = 1996)
plot_recruitment(mod_list_avg, file = file_name, add_ci = FALSE, model_names = mod_list_avg_names, right_adj = 0.1, line_col = line_col_avg, lwd = 2, minyr = 1996)
