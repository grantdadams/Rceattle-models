...
################################################
# Read the data in
mydata <- Rceattle::read_data( file = "GOA_18.1.1/GOA_18_1_1.xlsx")
...
ss_run_re <- Rceattle::fit_mod(data_list = mydata,
...
file_name <- "GOA_18.1.0/Figures/GOA_18.1.1_re"
plot_index(ss_run_re, file = file_name)
plot_catch(ss_run_re, file = file_name)
Rceattle::plot_srv_comp(ss_run_re, file = file_name)
Rceattle::plot_fsh_comp(ss_run_re, file = file_name)
plot_biomass(ss_run_re, file = file_name)
plot_recruitment(ss_run_re, file = file_name)
plot_selectivity(ss_run_re, file = file_name)
