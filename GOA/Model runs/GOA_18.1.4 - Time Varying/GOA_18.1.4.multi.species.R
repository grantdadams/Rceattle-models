...
file_name <- "Figures/MS_base/MS_base"
...
plot_biomass(list(ms_run_mod1, ss_run_mod4), file = file_name, model_names = c("MS", "SS"))
...
plot_mort(Rceattle = list(ss_run_mod4, ms_run_mod1), age = 1)
