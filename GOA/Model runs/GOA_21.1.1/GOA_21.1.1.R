...
# - Short
mydata_aaf_short <- Rceattle::read_data( file = "Data/GOA_21_1_1_data_1996-2021_aaf_short.xlsx")
mydata_coastwide_short <- Rceattle::read_data( file = "Data/GOA_21_1_1_data_1996-2021_coastwide_short.xlsx")
