...
################################################
# Read the data in
mydata_aaf <- Rceattle::read_data( file = "GOA_20.1.1_aaf_halibut_total_diet2.xlsx")
mydata_coastwide <- Rceattle::read_data( file = "GOA_20.1.1_coastwide_halibut_total_diet2.xlsx")
mydata_survey <- Rceattle::read_data( file = "GOA_20.1.1_survey_halibut_total_diet2.xlsx")
mydata_no_hal <- Rceattle::read_data( file = "GOA_20.1.1_coastwide_halibut_total_no_halibut_uobs.xlsx")
