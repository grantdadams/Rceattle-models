# Main difference is that ageing error from Steve's 2018 assessment for Cod is input

library(Rceattle)
setwd("Model runs/GOA_18.4.1")
...
################################################
# Read the data in
mydata_aaf <- Rceattle::read_data( file = "GOA_18.4.1_small_pcod_removed_aaf_halibut_total_diet2.xlsx")
mydata_coastwide <- Rceattle::read_data( file = "GOA_18.4.1_small_pcod_removed_coastwide_halibut_total_diet2.xlsx")
mydata_survey <- Rceattle::read_data( file = "GOA_18.4.1_small_pcod_removed_survey_halibut_total_diet2.xlsx")
mydata_no_hal <- Rceattle::read_data( file = "GOA_18.4.1_small_pcod_removed_coastwide_halibut_total_no_halibut_uobs.xlsx")
...
save(mod_list_all, file = "Models/18.4.2.RData")

file_name <- "Figures/18.4.2_models_long"
...
write.csv(nll_long, "Figures/18.4.2.long_model_nll.csv")

# Short
file_name <- "Figures/18.4.2_models_short"
...
file_name <- "Figures/18.4.2_models_all"
