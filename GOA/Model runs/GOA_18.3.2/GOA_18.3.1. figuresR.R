...
plot_index(mod_list_long, file = file_name, model_names = mod_names_long, right_adj = 9)
plot_logindex(mod_list_long, file = file_name, model_names = mod_names_long, right_adj = 0.25, top_adj = 0.1)
plot_catch(mod_list_long, file = file_name, model_names = mod_names_long, right_adj = 0.25, top_adj = 0.1)
...
plot_index(mod_list_short, file = file_name, model_names = mod_names_short, right_adj = 5.5)
plot_logindex(mod_list_short, file = file_name, model_names = mod_names_short, right_adj = 0.1)
plot_catch(mod_list_short, file = file_name, model_names = mod_names_short, right_adj = 0.1)
