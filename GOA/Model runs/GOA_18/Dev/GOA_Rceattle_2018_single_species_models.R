...
# Pollock
mydata_pollock <- data("GOApollock")
...
pollock_model <- Rceattle::fit_mod(
  ...
  debug = 0, # 0 = Estimate, 1 = Dont run estimation
  random_rec = FALSE, # No random recruitment
  msmMode = 0, # 0 = Single species mode, 1 = MSVPA multi-species mode
  silent = TRUE, # True = hide optimization output
  recompile = FALSE, # False = do not recompile CPP file
  phase = "default") # Use default phasing

# Random recruitment pollock model
pollock_model_re <- Rceattle::fit_mod(
  data_list = mydata_pollock,
  inits = NULL, # Initial parameters = 0
  file = NULL, # Don't save
  debug = 0, # 0 = Estimate, 1 = Dont run estimation
  random_rec = TRUE, # Add random recruitment
  msmMode = 0, # 0 = Single species mode, 1 = MSVPA multi-species mode
  silent = FALSE, # FALSE = show optimization output
  recompile = FALSE, # False = do not recompile CPP file
  phase = "default") # Use default phasing
