...
################################################
# Read the data in
mydata <- Rceattle::read_data( file = "GOA_18.1.3 - Time Varying/GOA2017SS_v4.xlsx")
...
# Try with dome shaped selectivity 
################################################
# Data
################################################
# Read the data in
mydata <- Rceattle::read_data( file = "GOA_18.1.1/GOA2017SS_v3_from_1977_v2_fit_switch.xlsx")
mydata$fsh_control$Nselages[15]
