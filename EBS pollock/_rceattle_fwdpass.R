...
par_lines <- readLines("ADMB/m23/pm.par"); rep_lines <- readLines("ADMB/m23/pm.rep")
...
log_avgrec<-get_par("log_avgrec"); log_avg_F<-get_par("log_avg_F")
...
bts_slp_dev<-get_par("sel_slp_bts_dev"); bts_a50_dev<-get_par("sel_a50_bts_dev"); bts_a1_dev<-get_par("sel_age_one_bts_dev")
